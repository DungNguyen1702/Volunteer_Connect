...
public class CandidateController {
    ...
    @PostMapping("/create")
    ResponseEntity<StatusResponse> createCandidate(@RequestHeader("Authorization") String token,
    ...
    @PostMapping("/update")
    ResponseEntity<StatusResponse> updateCandidate(@RequestHeader("Authorization") String token,
            @RequestBody CandidateRequest CandidateRequest) {
        token = token.substring("Bearer ".length());
    ...
    @PostMapping("/delete")
    ResponseEntity<StatusResponse> deleteCandidate(@RequestHeader("Authorization") String token,
            @RequestBody CandidateRequest CandidateRequest) {
        token = token.substring("Bearer ".length());
    ...
    ResponseEntity<List<Candidate>> selectAllCandidate(@RequestHeader("Authorization") String token,
            @RequestBody CandidateRequest CandidateRequest) {
        token = token.substring("Bearer ".length());
