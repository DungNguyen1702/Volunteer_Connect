...
function ActivityDetail() {
    ...
    const confirmApplyForm = (applyFormId)=>{
        const findApplyForm = listApplyForm.find(applyForm => applyForm.id === applyFormId);
            ...
            <div class="activity-detail-header">
                ...
                <div id="activity-header-content-wrapper">
                    ...
                    <h3
                        id="activity-status"
                        style={{
                            backgroundColor: COLOR_STATUS[activityStatus],
                    ...
                    <div id="tabbar-button-wrapper">
                        ...
                        >
                            ...
                            />
                            {tabButton === 1 ? (
                                <p class="tab-button-text">Task management</p>
                            ) : null}
                        </Button>
                        <Button
                            className={`tabbar-button ${
                        ...
                        >
                            ...
                            />
                            {tabButton === 2 ? (
                                <p class="tab-button-text">Post management</p>
                            ) : null}
                        </Button>
                        <Button
                            className={`tabbar-button ${
                        ...
                        >
                            ...
                            />
                            {tabButton === 3 ? (
                                <p class="tab-button-text">Member management</p>
                            ) : null}
                        </Button>
                    </div>
                </div>
