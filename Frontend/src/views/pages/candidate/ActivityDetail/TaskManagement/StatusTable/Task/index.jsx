        ...
        >
            <div onClick={onClickTask} class="task-item-container">
                ...
                <div className="task-item-content">
                    <h3 class="task-item-title">{SupportFunction.TruncateText(taskInfo.title, 25)}</h3>
                    ...
                    <div class="task-item-description">
                        <p>{SupportFunction.TruncateText(
                    ...
                    <div class="task-item-footer">
                        ...
                        {candidate ? (
                            <CandidateAva
                                ...
                                backgroundNoAva={candidate.user.account.backgroundNoAva}
                            />
                        ) : (
